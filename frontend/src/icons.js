/* 内联 SVG 图标（线性描边风格，stroke 继承 currentColor） */
export const ICONS = {
  ...
  alertTriangle: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M10.3 3.9L1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"/><path d="M12 9v4M12 17h.01"/></svg>',
  check: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>',
  checkCircle: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12.5l2.5 2.5L16 9.5"/></svg>',
  ...
  robot: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="8" width="16" height="12" rx="3"/><path d="M12 8V4M8 4h8"/><circle cx="9" cy="14" r="1.2"/><circle cx="15" cy="14" r="1.2"/><path d="M2 13v3M22 13v3"/></svg>',
  ...
  ban: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M4.9 4.9l14.2 14.2"/></svg>',
  play: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 4.5l13 7.5-13 7.5v-15z"/></svg>',
...
export const EVENT_META = {
  log: { label: "日志", cls: "ev-log", icon: "terminal" },
  round: { label: "巡检", cls: "ev-round", icon: "activity" },
  status: { label: "状态", cls: "ev-status", icon: "refresh" },
  decision: { label: "决策", cls: "ev-decision", icon: "chip" },
  human: { label: "转人工", cls: "ev-human", icon: "user" },
  unknown: { label: "未识别", cls: "ev-unknown", icon: "alertTriangle" },
  ack: { label: "已了解", cls: "ev-ack", icon: "check" },
  send: { label: "已回复", cls: "ev-send", icon: "send" },
};

export const EVENT_ORDER = ["log", "round", "status", "decision", "send", "human", "unknown", "ack"];
